...
main(int argc, char **argv)
{
    ...
    while(readAndParse(inFilePtr, label, opcode, arg0, arg1, arg2)){
        ...
        if (!strcmp(opcode, ".fill")){
            ...
            }// label should equate to value needed to get back to label -> label index = index + 1 - equate
            assembled = 0b100 << 22;
